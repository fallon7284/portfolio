                ...
                <div className="contact">
                    <div className="contact-left">
                        <div className="contact-me">
                            ...
                            >
                                <a
                                    href="http://linkedin.com/in/brendanfallondev"
                                    target="blank"
                                ...
                                <a
                                    href="http://github.com/fallon7284"
                                    target="blank"
                                    rel="noopener noreferrer"
                                >
                            ...
                            If you'd like to get in touch with me, you can leave
                            a message below, or click the email button in the
                            top bar. I'd love to hear from you.
                        </div>
                        <div
                            className={`comment-button${
                                this.state.commenting ? '-open' : ''
                            }`}
                            style={{
                                marginTop: '1vh',
                                fontFamily: 'nick',
                        ...
                        <div className="form-area">
                            {this.state.commenting && (
                                <ContactForm
                                    ...
                                    messageValid={this.messageValid(
                                        userName,
                                        userEmail,
                                        message
                                    )}
